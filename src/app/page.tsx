...
export default async function DashboardPage() {
  ...
  return (
    <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "2rem" }}>
      <h1 style={{ marginBottom: "2rem" }}>Pricing Dashboard</h1>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "1.5rem", fontWeight: "600" }}>
            {formatCurrency(totalOverheadMonthly, currency)}
          </div>
          <div style={{ fontSize: "0.85rem", color: "#666", marginTop: "0.5rem" }}>
                  ...
                  <tr key={stack.id}>
                    ...
                    <td style={{ padding: "0.75rem", borderBottom: "1px solid #ddd", textAlign: "right" }}>
                      {result.devCostPerRelHour !== null
                        ? formatCurrency(result.devCostPerRelHour, currency)
                        : "N/A"}
                    </td>
                    <td style={{ padding: "0.75rem", borderBottom: "1px solid #ddd", textAlign: "right" }}>
                      {result.releaseableCost !== null
                        ? formatCurrency(result.releaseableCost, currency)
                        : "N/A"}
                    </td>
                    <td style={{ padding: "0.75rem", borderBottom: "1px solid #ddd", textAlign: "right" }}>
                      {result.finalPrice !== null ? formatCurrency(result.finalPrice, currency) : "N/A"}
                    </td>
                  </tr>
                ))}
              </tbody>
                ...
                {overheadData.map(({ type, allocationSum, missingCount, monthlyEquivalentConverted, isValid }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ padding: "0.75rem", borderBottom: "1px solid #ddd", textAlign: "right" }}>
                        {formatCurrency(amountConverted, currency)}
                      </td>
                      ...
                      <td style={{ padding: "0.75rem", borderBottom: "1px solid #ddd", textAlign: "right" }}>
                        {formatCurrency(monthlyEquivalentConverted, currency)}
                      </td>
                      <td
                        style={{
                          padding: "0.75rem",
